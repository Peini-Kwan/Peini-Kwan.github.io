...
---
### Conference Papers
* [IEEE S&P'26] **Haoxin Tu**, Seongmin Lee, Yuxian Li, Peng Chen, Lingxiao Jiang, and Marcel Böhme, "**Cottontail: Large Language Model-Driven Concolic Execution for Highly Structured Test Input Generation**", to appear at IEEE Symposium on
Security and Privacy (S&P 2026). [[PDF]](https://haoxintu.github.io/files/sp2026-cottontail.pdf) [[Extended Appendix]](https://arxiv.org/pdf/2504.17542) [[Code]](https://github.com/Cottontail-Proj/cottontail) (to be released soon).
